        ...
        <form method="post" action="suggest.php">
            ...
            <tr>
                ...
                <td><select id="category" name="category">
                    ...
                    <option value="Fruits"<?php if (isset($category) && $category == "Fruits") { echo " selected"; } ?>>Book</option>
                    <option value="Veges"<?php if (isset($category) && $category == "Veges") { echo " selected"; } ?>>Movie</option>
                    <option value="Grains"<?php if (isset($category) && $category == "Grains") { echo " selected"; } ?>>Grains</option>
                </select></td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="genre" id="genre">
                        ...
                        <optgroup label="Veges">
                            ...
                            <option value="Grainsal"<?php
                            if (isset($genre) && $genre=="Grainsal") {
                                echo " selected";
                            } ?>>Grainsal</option>
                            <option value="Mystery"<?php
                            if (isset($genre) && $genre=="Mystery") {
